...
function AuthIntroMobile() {
  ...
  return (
    ...
    >
      <div className="flex items-start gap-4 flex-col w-full relative">
        ...
        <Button
          ...
          style={{
            ...
            top: "50%",
            transform: `${
              isExpanded ? "translateY(-50%)" : "translateY(-100%)"
            }`,
            right: isExpanded ? "0" : "calc(90vw - 48px)",
          }}
        />
        ...
        <AnimatePresence>
          {isExpanded && (
            <motion.div
              ...
              className="w-full pt-2 px-5 pb-4"
            >
              {/* Header */}
